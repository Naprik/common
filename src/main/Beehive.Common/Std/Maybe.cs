...
using Beehive.Common.Properties;
...
namespace Beehive.Common.Std
{
    ...
    class None<TVal> : Maybe<TVal>
    {
        ...
        public override Maybe<TOut> FlatMap<TOut>(Func<TVal, Maybe<TOut>> func) => Maybe.NoneFor<TOut>();
    }
    ...
    public static class MaybeExtensions
    {
        ...
        public static Maybe<TOut> Map<TVal, TOut>(this Maybe<TVal> ctx, Func<TVal, TOut> map) 
            => ctx.FlatMap(_ => Maybe.ApplyTo(map(_)));
        ...
        public static Maybe<T> AsMaybe<T>(this T obj) => Maybe.ApplyTo(obj);
    }
